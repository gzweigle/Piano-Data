...
5. 6. 7. Single fast keypresses.
8. 9. 10. 11. 12. 13. 14. 15. Repeated keystrikes.
...
to a computer. A short python program receives the data and stores into
a .txt file.
...
The two sensors are measuring a physical object that is traveling two different
...
taped it next to the CNY70, adjacent to the location of light sending emitter on
